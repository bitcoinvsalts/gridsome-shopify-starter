    ...
    <header class="border-t-14 border-gray-900">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        <div class="block lg:hidden">
          <button aria-label="theme-switcher" @click="toggle" class="flex items-center px-3 py-2 border rounded border-gray-500 hover:text-gray-600 hover:border-gray-600">
    ...
    <footer class="bg-gray-900 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
            ...
            <li class="mr-8">
                <a href="https://github.com/jsappme/" aria-label="GitHub" target="_blank" class="text-white hover:text-gray-400">
            ...
            <li class="mr-8">
                <a href="https://twitter.com/herve76" aria-label="Twitter"  target="_blank" class="text-white hover:text-gray-400">
            ...
            <li class="mr-8">
                <a href="https://www.linkedin.com/in/hervefulchiron/" aria-label="LinkedIn"  target="_blank" class="text-white hover:text-gray-400">
            ...
            <li>
                <a href="https://www.instagram.com/herve76/" aria-label="Instagram" target="_blank" class="text-white hover:text-gray-400">
