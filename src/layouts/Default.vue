    ...
    <footer class="bg-gray-900 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
            ...
            <li class="mr-8">
                <a href="https://github.com/jsappme/" target="_blank" class="text-white hover:text-gray-400">
            ...
            <li class="mr-8">
                <a href="https://www.linkedin.com/in/hervefulchiron/" target="_blank" class="text-white hover:text-gray-400">
            ...
            <li>
                <a href="https://www.instagram.com/herve76/" target="_blank" class="text-white hover:text-gray-400">
